...
pd.DataFrame({
    ...
    os.path.join(out_path, "pca_summary.csv"),
    index=False
)
...
# comparison = pd.DataFrame(comparisons_ftp)
# comparison.to_csv(
#     os.path.join(out_path, "FPT_comparison.csv"), index=False
# )

# pd.DataFrame(R_obs, columns=prices.columns).to_csv(
# os.path.join(out_path, "R.csv"), index=False
# )

# pd.DataFrame(J_obs, columns=prices.columns).to_csv(
#     os.path.join(out_path, "J.csv"), index=False
# )

# pd.DataFrame(Jsim, columns=prices.columns).to_csv(
#     os.path.join(out_path, "Jsim.csv"), index=False
# )
